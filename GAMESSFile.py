...
## Author: Andrew Hoos
## File: GAMESSFile.py
## Purpose: The purpose of this file is to define the data types 
## used to manipulate GAMESS input files. This allows manipulation 
## of files using keys and indexes. They also overload the to string 
## function to enable easy printing.
## Limitations: Inputs to the constructors must be properly formatted 
## usage: see rscan.py
## Version: 0.4.1
...
# represents a group in GAMESS input file e.g. $STATPT
...
# represents a the $DATA group in a GAMESS input file    
...
# represents an entire GAMESS input file
class GMSFile(OrderedDict):

  #parses a group into a DATA group, a VEC string, or normal group 
